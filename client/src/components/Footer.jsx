    ...
    <footer className="relative bg-gradient-to-br from-[#0b1825] via-[#162d4a] to-[#1e3858] text-white overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-14 relative z-10">
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-10 mb-12">
          ...
          {/* Brand */}
          <div>
            <p className="text-lg font-bold tracking-tight text-white mb-3">Adjoba Mushia Cobbold</p>
            <p className="text-sm text-slate-400 leading-relaxed max-w-xs">
              MSc Finance &amp; FinTech — bridging financial insight and data-driven decision making.
            </p>
          </div>

          {/* Navigation */}
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-[#c9a84c] mb-5">Navigate</p>
          ...
          {/* Connect */}
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-[#c9a84c] mb-5">Connect</p>
            <ul className="space-y-2.5">
              <li>
