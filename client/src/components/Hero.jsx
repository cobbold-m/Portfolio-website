          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                className="px-5 py-2.5 bg-[#1e3a5f] text-white font-medium rounded-lg hover:bg-[#2a4f7f] transition-all duration-200 shadow-sm hover:shadow-md text-sm"
              >
                View Projects
              </a>
              <a
                ...
                className="px-5 py-2.5 border-2 border-[#1e3a5f] text-[#1e3a5f] font-medium rounded-lg hover:bg-[#1e3a5f] hover:text-white transition-all duration-200 text-sm"
              >
                Download CV
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-5 py-2.5 border border-[#e2e8f0] text-slate-600 font-medium rounded-lg hover:border-[#3b82f6] hover:text-[#3b82f6] transition-all duration-200 flex items-center gap-2 text-sm"
              >
